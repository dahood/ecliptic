...
#region Variable Block
    ...
    $script:this = @{
        ...
        shoppingCart = @{
                ...
                solution = "$rootDir\src\ShoppingCartApp\ShoppingCartApp.csproj"
                projectDir = "$rootDir\src\ShoppingCartApp"
                testAssemblyFile = "$rootDir\build-artifacts\output\ShoppingCartApp.Tests.dll"
...
task test -depends ShoppingCartTests
